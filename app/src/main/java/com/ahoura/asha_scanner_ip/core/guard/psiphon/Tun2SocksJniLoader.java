...
public class Tun2SocksJniLoader {
    ...
    static {
        try {
            ...
            android.util.Log.e("Tun2SocksJniLoader", "Failed to load libtun2socks.so", t);
        }
    }
    ...
    public static void initializeLogger(String className, String methodName) {
        ...
        try {
            ...
            android.util.Log.e("Tun2SocksJniLoader", "initTun2socksLogger error", t);
        }
    }
    ...
    public native static void runTun2Socks(
            ...
            // Asha Guard: when 1, udpgw accepts only DNS (UDP port 53); all other
